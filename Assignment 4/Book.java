 ...
 * @Description: This class is inherited from Readable class, this class is inherited from item class, declares Readable type Book
 */
...
public class Book extends Readable{
	...
	public Book (int serial, String title, String author, int cost, int amount){
		//sets serial number
		sNo = serial;
		// sets product name
		name = title;
